#include "NN/L1TSC4NGJetModel_v1_0_2.h" //include of the top level of HLS model
...
using namespace hls4ml_L1TSC4NGJetModel_v1_0_2;
...
class L1TSC4NGJetModel_emulator_v1_0_2 : public hls4mlEmulator::Model{
    private:
    ...
    public:
        ...
        {
            L1TSC4NGJetModel_v1_0_2(basic_input, class_out, reg_out);
...
{
    return new L1TSC4NGJetModel_emulator_v1_0_2;
}
