...
class L1TSC4NGJetModel_emulator_test : public hls4mlEmulator::Model{
    ...
    public:
        ...
        { 
            std::pair<std::array<layer24_t,N_LAYER_23>,std::array<layer25_t,N_LAYER_22>> *result_p = std::any_cast<std::pair<std::array<layer24_t,N_LAYER_23>,std::array<layer25_t,N_LAYER_22>>*>(result);
