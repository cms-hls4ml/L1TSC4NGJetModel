#include "NN/L1TSC4NGJetModel_v1.h" //include of the top level of HLS model
...
using namespace hls4ml_L1TSC4NGJetModel_v1;

class L1TSC4NGJetModel_emulator_v1 : public hls4mlEmulator::Model{
    private:
    ...
    public:
        ...
        {
            L1TSC4NGJetModel_v1(_input, _layer22_out, _layer24_out);
...
{
    return new L1TSC4NGJetModel_emulator_v1;
}
